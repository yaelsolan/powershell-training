...
$OperatorPassword = Read-Host -AsSecureString
...
$userParams = @{
	...
	AccountPassword = $OperatorPassword
...
$cred = Get-Credential adatum\DnsOperator
Enter-PSSession -ComputerName PSHELL-DC -ConfigurationName JEA_DNS # This will fail
Enter-PSSession -ComputerName PSHELL-DC -ConfigurationName JEA_DNS -Credential $cred
Get-Command
Get-WhoAmI
